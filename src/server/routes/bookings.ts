...
export const bookingsRouter = router({
  ...
  create: publicProcedure.input(z.object({
    ...
    const [result] = await db.insert(schema.bookings).values({
      ...
      source: ctx.isAdmin ? (input.source ?? (input.skipPayment ? 'direct' : 'website')) : 'website',
  ...
  update: adminProcedure.input(z.object({
    ...
    departurePort: z.string().optional(),
    specialRequests: z.string().optional(),
    stayType: z.enum(['airbnb', 'hotel', 'private_residence', 'marina', 'anchoring', 'other']).nullable().optional(),
    stayAddress: z.string().nullable().optional(),
    dockingDetails: z.string().nullable().optional(),
    stayContactName: z.string().nullable().optional(),
    stayContactPhone: z.string().nullable().optional(),
