            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="bg-slate-900 rounded-xl p-6 text-white">
                  ...
                  <div className="flex gap-3">
                    <a href="sms:7542542293&body=Hi, I'm a boat owner in the Keys and I'm interested in listing my vessel with Blue Skies Boat Rentals."
                    ...
                    <a href="tel:7542542293" className="text-slate-400 hover:text-white text-xs flex items-center gap-1 transition-colors">
                      (754) 254-2293
                    </a>
                  </div>
                </div>
