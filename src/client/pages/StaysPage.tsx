    ...
    <div className="bg-white">
      ...
      <div className="bg-slate-50 text-slate-900 py-10 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <a href="sms:3055550000&body=Hi, I'm interested in a stay + boat package in the Keys."
            ...
            >
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <a href="sms:3055550000" className="text-slate-300 hover:text-slate-900 flex items-center transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-slate-400 text-sm mt-4">
                  or <a href="sms:3055550000" className="text-sky-500 hover:text-sky-400 underline underline-offset-2">text us</a> to chat
                </p>
              </div>
            </div>
          </div>
