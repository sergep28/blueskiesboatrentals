          ...
          <div className="md:col-span-2">
            <div className="sticky top-6 space-y-5">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                ...
                {/* Book button */}
                <a
                  href={`sms:3055550000&body=Hi, I'd like to book ${property.name} in ${property.location}.${checkIn ? ` Check-in: ${checkIn}.` : ''}${checkOut ? ` Check-out: ${checkOut}.` : ''} ${guests} guests.`}
              ...
              <div className="text-center">
                <a href="sms:3055550000" className="text-slate-400 text-xs hover:text-slate-900 transition-colors flex items-center justify-center gap-1.5">
