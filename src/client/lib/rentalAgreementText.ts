// Single source of truth for the bareboat rental agreement text.
// Rendered on the public /rental-agreement page AND embedded into the signed
// PDF downloaded from Admin → Bookings, so the two can never drift apart.
...
export const AGREEMENT_ACKNOWLEDGMENT =
