...
// AI Agent: social media posts generated by the content agent
export const socialPosts = pgTable('social_posts', {
  id: serial('id').primaryKey(),
  platform: text('platform', { enum: ['instagram', 'facebook', 'google_business', 'tiktok'] }).notNull(),
  theme: text('theme').notNull(),
  content: text('content').notNull(),
  hashtags: text('hashtags'),
  imageSuggestion: text('image_suggestion'),
  photoFileId: text('photo_file_id'),
  photoName: text('photo_name'),
  photoUrl: text('photo_url'),
  status: text('status', { enum: ['pending', 'approved', 'rejected', 'posted'] }).default('pending').notNull(),
